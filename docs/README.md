...
- [Product Manager User Guide](user-guides/product-manager-guide.md)
- [BI Analyst User Guide](user-guides/bi-analyst-guide.md)
- [Executive Viewer User Guide](user-guides/executive-viewer-guide.md)
- [System Auditor User Guide](user-guides/system-auditor-guide.md)
- [Segmentation User Guide](user-guides/segmentation-user-guide.md)

## Architecture

- [Initial Architecture Diagram](architecture/initial-architecture.md)
...
- [Beneficiary Module Documentation](modules/beneficiary-module.md)
- [Consent Module Documentation](modules/consent-module.md)
- [Product Module Documentation](modules/product-module.md)
- [Product Ownership Documentation](modules/product-ownership.md)
- [Payment Record Documentation](modules/payment-records.md)
- [Campaign Lifecycle Documentation](modules/campaign-lifecycle.md)
- [Campaign Launch Documentation](modules/campaign-launch.md)
...
- [Campaign Audit Logging Documentation](modules/campaign-audit-logging.md)
- [Audit Logging Documentation](modules/audit-logging.md)
- [System Settings Documentation](modules/system-settings.md)
...
- [Recipient Preview Documentation](modules/recipient-preview.md)
- [Communication Tracking Documentation](modules/communication-tracking.md)
- [Follow-Up Task Documentation](modules/follow-up-tasks.md)
- [Reminder Scheduling Documentation](modules/reminder-scheduling.md)
- [Green / Yellow / Red Reminder Rules](modules/green-yellow-red-reminder-rules.md)
- [Reminder Scheduler Documentation](modules/reminder-scheduler.md)
- [Analytics Module Documentation](modules/analytics-module.md)
- [KPI Definition Document](modules/kpi-definitions.md)
- [Report Export Documentation](modules/report-export.md)
- [AI Feature Documentation](modules/ai-features.md)
- [AI Limitations and Human Approval Policy](modules/ai-limitations-and-human-approval.md)
- [AI Decision-Support Explanation](modules/ai-decision-support-explanation.md)
- [AI Test Evidence](modules/ai-test-evidence.md)
...
- [Functional Requirements Test Map](testing/functional-requirements-test-map.md) (item **620**)
- [Business Rules Test Map](testing/business-rules-test-map.md) (item **621**)
- [Non-Functional Requirements Test Map](testing/non-functional-requirements-test-map.md) (item **622**)
- [Performance Smoke Checks](testing/performance-smoke.md) (item **639** / NFR-003)
...
- [Frontend Component Tests](testing/frontend-component-tests.md) (item **595**)
- [Frontend Integration Tests](testing/frontend-integration-tests.md) (item **596**)
- [Playwright Happy-Path E2E](testing/playwright-e2e.md) (item **597**)
- [UI Login Flow](testing/ui-login-flow.md) (item **598**)
- [UI Customer Creation](testing/ui-customer-creation.md) (item **599**)
- [UI Consent Update](testing/ui-consent-update.md) (item **600**)
- [UI Product Creation](testing/ui-product-creation.md) (item **601**)
- [UI Segment Creation](testing/ui-segment-creation.md) (item **602**)
- [UI Campaign Creation](testing/ui-campaign-creation.md) (item **603**)
- [UI Compliance Approval](testing/ui-compliance-approval.md) (item **604**)
- [UI Campaign Launch](testing/ui-campaign-launch.md) (item **605**)
- [UI Dashboard Analytics](testing/ui-dashboard-analytics.md) (item **606**)
- [UI Role-Based Menu](testing/ui-role-based-menu.md) (item **607**)
- [UI Keyboard Navigation](testing/ui-keyboard-navigation.md) (item **608**)
- [UI Main Screens Accessibility](testing/ui-main-screens-accessibility.md) (item **609**)
