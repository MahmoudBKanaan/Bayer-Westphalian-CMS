 ...
 * consent}), {@code consent_type} (alias {@code consenttype}), {@code has_valid_marketing_consent}
 * (aliases {@code valid_marketing_consent}, {@code marketing_consent}), {@code opt_out} (aliases
 * {@code optout}, {@code marketing_opt_out}, {@code opted_out}), and {@code
 * has_valid_guardian_consent} (aliases {@code valid_guardian_consent}, {@code guardian_consent}).
 *
    ...
    private static String normalizeSingleFilterValue(String canonicalField, String rawValue) {
        ...
        return switch (canonicalField) {
            ...
            case "has_valid_marketing_consent", "opt_out", "has_valid_guardian_consent" ->
                    Boolean.toString(parseBoolean(rawValue));
