...
public record CreateCampaignRequest(
        @NotBlank(message = "Campaign name is required.") @Size(max = 255, message = "Campaign name must be 255 characters or fewer.") String name,
        ...
        @Size(max = 255, message = "Message subject must be 255 characters or fewer.") String messageSubject,
        String messageBody,
        LocalDate startDate,
        LocalDate endDate,
