...
class SecurityConfiguration {
    ...
    static final String[] CAMPAIGN_MANAGER_ROLES = roles(SystemRoleName.CAMPAIGN_MANAGER);
    static final String[] CAMPAIGN_SEGMENT_PREVIEW_ROLES =
            roles(SystemRoleName.CAMPAIGN_MANAGER, SystemRoleName.BI_ANALYST);
    static final String[] COMPLIANCE_ROLES = roles(SystemRoleName.COMPLIANCE_OFFICER);
    static final String[] CAMPAIGN_RECIPIENT_ROLES =
            roles(SystemRoleName.CAMPAIGN_MANAGER, SystemRoleName.COMPLIANCE_OFFICER);
    static final String[] CAMPAIGN_READ_ROLES =
            roles(
                    SystemRoleName.ADMIN,
                    SystemRoleName.CAMPAIGN_MANAGER,
                    SystemRoleName.BI_ANALYST,
                ...
                .authorizeHttpRequests(
                        authorization ->
                                authorization
                                        ...
                                        .hasAnyRole(CAMPAIGN_SEGMENT_PREVIEW_ROLES)
