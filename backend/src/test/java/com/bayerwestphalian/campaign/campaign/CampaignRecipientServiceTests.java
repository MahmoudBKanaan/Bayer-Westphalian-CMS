...
class CampaignRecipientServiceTests {
    ...
    private static final UUID CAMPAIGN_ID = UUID.fromString("50000000-0000-0000-0000-000000000267");
    private static final UUID SEGMENT_ID = UUID.fromString("42000000-0000-0000-0000-000000000267");
    private static final UUID OWNER_ID = UUID.fromString("10000000-0000-0000-0000-000000000267");
    ...
    void summarizeRecipientsDeclaresCampaignReadAccess() throws Exception {
        Method method = CampaignRecipientService.class.getMethod("summarizeRecipients", UUID.class);
    ...
    void listsOnlyStoredEligibleRecipientsForCampaign() {
        ...
        ReflectionTestUtils.setField(eligible, "createdAt", Instant.parse("2026-07-09T10:15:30Z"));
        when(campaignRepository.findById(CAMPAIGN_ID)).thenReturn(Optional.of(campaign));
    ...
    void listsOnlyStoredExcludedRecipientsForCampaign() {
        ...
        ReflectionTestUtils.setField(excluded, "createdAt", Instant.parse("2026-07-09T10:45:30Z"));
        when(campaignRepository.findById(CAMPAIGN_ID)).thenReturn(Optional.of(campaign));
        when(campaignRecipientRepository.findByCampaignIdAndEligibilityStatus(
    ...
    void summarizesEligibleExcludedSentAndFailedRecipientCounts() {
        ...
        verify(campaignRecipientRepository)
                .countByCampaignIdAndEligibilityStatus(CAMPAIGN_ID, CampaignRecipientStatus.FAILED);
    }
    ...
    private static Campaign campaign() {
        ...
        Segment segment = Segment.create("Generation segment", null, owner, SegmentVisibility.TEAM);
