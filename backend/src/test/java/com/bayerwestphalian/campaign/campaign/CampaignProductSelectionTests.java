...
/**
 * KB item 221 / FR-052: campaign product selection via {@code PUT/GET
...
class CampaignProductSelectionTests {
    ...
    void campaignManagerCanSelectPromotedProducts() throws Exception {
        ...
        when(campaignService.selectProducts(
                        eq(CAMPAIGN_ID), any(SelectCampaignProductsCommand.class)))
        ...
        assertThat(commandCaptor.getValue().productIds()).containsExactly(PRODUCT_ID, PRODUCT_ID_2);
    }
