...
class CampaignDtoTests {
    ...
    void validatesCreateAndUpdateCampaignRequestFieldsFromKb() throws Exception {
        assertThat(field(CreateCampaignRequest.class, "name").isAnnotationPresent(NotBlank.class))
                .isTrue();
        assertThat(
                        field(CreateCampaignRequest.class, "name")
        ...
        assertThat(field(CreateCampaignRequest.class, "channel").isAnnotationPresent(NotNull.class))
                .isTrue();
        assertThat(
        ...
        assertThat(field(UpdateCampaignRequest.class, "name").isAnnotationPresent(NotBlank.class))
                .isTrue();
        assertThat(
                        field(UpdateCampaignRequest.class, "name")
                                .getAnnotation(NotBlank.class)
                                .message())
                .isEqualTo("Campaign name is required.");
        assertThat(
                        field(UpdateCampaignRequest.class, "objective")
                                .isAnnotationPresent(NotBlank.class))
                .isTrue();
        assertThat(field(UpdateCampaignRequest.class, "channel").isAnnotationPresent(NotNull.class))
                .isTrue();
        assertThat(
    ...
    void mapsRejectCampaignRequestToCommand() {
        ...
        assertThat(command.rejectionReason()).isEqualTo("Missing consent language in message body");
    ...
    void rejectsCreateCampaignRequestWithoutRequiredKbFields() {
        CreateCampaignRequest request =
                new CreateCampaignRequest(
                        " ", " ", null, null, "X".repeat(256), null, null, null, List.of());
    ...
    void rejectsUpdateCampaignRequestWithoutRequiredKbFields() {
        UpdateCampaignRequest request =
                new UpdateCampaignRequest(
                        "", null, null, null, "X".repeat(256), null, null, null, null);
    ...
    void mapsCampaignViewWithoutProductIdsAsEmptyList() {
        User owner = User.create("cm@test", "$2a$10$hash", "CM");
        ReflectionTestUtils.setField(owner, "id", OWNER_ID);
        Campaign campaign =
                Campaign.create("Simple", "Objective", owner, null, CampaignChannel.PHONE);
        ReflectionTestUtils.setField(campaign, "id", CAMPAIGN_ID);
    ...
    void mapsApprovedCampaignViewWithApproverFields() {
        User owner = User.create("cm@test", "$2a$10$hash", "Campaign Manager");
        User compliance = User.create("co@test", "$2a$10$hash", "Compliance Officer");
        ReflectionTestUtils.setField(owner, "id", OWNER_ID);
        ReflectionTestUtils.setField(
                compliance, "id", UUID.fromString("10000000-0000-0000-0000-000000000106"));
        ...
        Campaign campaign =
                Campaign.create(
                        "Approved campaign", "Ready to launch", owner, null, CampaignChannel.EMAIL);
        ReflectionTestUtils.setField(campaign, "id", CAMPAIGN_ID);
        campaign.submit();
