...
class CampaignComplianceReviewNotesTests {
    ...
    class Domain {
        ...
        void rejectStoresReasonAndOptionalComplianceReviewNotes() throws Exception {
            ...
            Campaign campaign =
                    Campaign.create(
                            "Review notes reject", "Objective", owner, null, CampaignChannel.EMAIL);
            campaign.submit();
        ...
        void recordComplianceReviewNotesRejectedOnDraft() throws Exception {
            ...
            Campaign campaign =
                    Campaign.create(
                            "Draft notes blocked", "Objective", owner, null, CampaignChannel.EMAIL);
    ...
    class Http {
        ...
        void rejectEndpointAcceptsReasonAndComplianceReviewNotes() throws Exception {
            ...
            mockMvc.perform(
                    ...
                    .andExpect(jsonPath("$.data.rejectionReason").value("Missing consent evidence"))
                    .andExpect(
        ...
        void recordsComplianceReviewNotesViaDedicatedEndpoint() throws Exception {
            ...
            when(campaignService.recordComplianceReviewNotes(
                    ...
                    .thenReturn(
                            viewWithNotes(CampaignStatus.SUBMITTED, null, "Pending legal review"));
            ...
            mockMvc.perform(
                    ...
                    .andExpect(
                            jsonPath("$.data.complianceReviewNotes").value("Pending legal review"));
