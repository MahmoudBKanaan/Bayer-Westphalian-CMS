...
/**
 * KB item 217: create campaign endpoint path through {@link CampaignService#createCampaign}
 * persists a DRAFT campaign with optional segment, products, message, and schedule (FR-050 /
 * FR-057). Create also writes a CREATE audit log (item 233).
 */
@DataJpaTest(
        properties = {
