...
class CampaignControllerTests {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(
                controller, "campaignRecipientService", campaignRecipientService);
        mockMvc =
    ...
    void exposesRoleBasedCampaignPermissionsAtControllerBoundary() throws Exception {
        ...
        assertPreAuthorize("summarizeCampaignRecipients", "@authz.canReadCampaigns()", UUID.class);
                ...
                .andExpect(
                        jsonPath(
                                ...
                                hasItems(
                                        ...
                                        "objective: Campaign objective is required.",
                                        "channel: Campaign channel is required.")));
    }
    ...
    void submitsCampaign() throws Exception {
        when(campaignService.submitCampaign(CAMPAIGN_ID))
                .thenReturn(viewWithStatus(CampaignStatus.SUBMITTED));
    ...
    void previewsCampaignRecipientsForSelectedSegment() throws Exception {
        ...
        mockMvc.perform(get("/api/campaigns/{id}/recipients/preview", CAMPAIGN_ID))
                ...
                .andExpect(
                        jsonPath("$.data.exclusionReasonSummary[0].code").value("INVALID_CONSENT"));
