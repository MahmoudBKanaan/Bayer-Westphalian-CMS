...
class SegmentTests {
    ...
    void supportsKbSegmentMaintenanceMethods() {
        User owner =
                User.create(
                        ...
                        "BI Analyst");
        ReflectionTestUtils.setField(
                owner, "id", UUID.fromString("10000000-0000-0000-0000-000000000002"));
        Segment segment =
                Segment.create("Draft audience", "Initial draft", owner, SegmentVisibility.PRIVATE);
    ...
    void managesCriteriaCollectionThroughKbAggregateMethods() {
        Segment segment =
                Segment.create("Audience with criteria", null, null, SegmentVisibility.TEAM);
