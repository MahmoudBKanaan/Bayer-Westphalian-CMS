...
class CampaignManagerCanCreateReusableSegmentTests {
    ...
    private static final UUID OWNER_ID = UUID.fromString("10000000-0000-0000-0000-000000000201");
    ...
    class ServiceAcceptance {
        ...
        @Test
        void campaignManagerCreatesReusableSegmentWithNameVisibilityAndCriteria() throws Exception {
        ...
        void campaignManagerCanCreateReusableSegmentForEveryVisibility(SegmentVisibility visibility)
                throws Exception {
            User owner = campaignManagerOwner();
            when(userRepository.findById(OWNER_ID)).thenReturn(Optional.of(owner));
            when(segmentRepository.save(any(Segment.class)))
        ...
        void createSegmentMethodUsesSegmentCreateAccessForCampaignManagerPath() throws Exception {
            ...
            SegmentCreateAccess createAccess =
                    createSegment.getAnnotation(SegmentCreateAccess.class);
        ...
        private User campaignManagerOwner() throws Exception {
            User owner =
                    User.create(
                            "campaign.manager@bayer-westphalian.test", "hash", "Campaign Manager");
