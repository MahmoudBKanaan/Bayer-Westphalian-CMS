...
class SegmentAndLogicReturnsCorrectResultTests {
    ...
    void twoFieldAndReturnsOnlyIntersection() throws Exception {
        ...
        assertThat(matches)
                ...
                .containsExactly("Lena Mueller", "Kai Fischer");
    ...
    void threeFieldAndExcludesEveryPartialMatch() throws Exception {
        ...
        assertThat(matches)
                .noneMatch(view -> view.fullName().equals("Anna Weber")); // Munich CUSTOMER
        assertThat(matches)
                .noneMatch(view -> view.fullName().equals("Tom Schmidt")); // Berlin PROSPECT
        assertThat(matches)
                .noneMatch(view -> view.fullName().equals("Max Bauer")); // Vienna PROSPECT
    ...
    void previewSegmentWithAndCriteriaReturnsOnlyIntersectionEligible() throws Exception {
        ...
        assertThat(preview.totalAudienceCount())
                .isEqualTo(2); // Lena (DE) + Kai (AT) both Munich prospects
