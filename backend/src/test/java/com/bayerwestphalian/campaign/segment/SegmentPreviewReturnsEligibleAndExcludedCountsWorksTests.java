...
class SegmentPreviewReturnsEligibleAndExcludedCountsWorksTests {
    ...
    @CsvSource({"0, 0, 0", "1, 0, 1", "0, 1, 1", "2, 1, 3", "1, 3, 4", "3, 2, 5"})
    void previewCountIdentityEligiblePlusExcludedEqualsTotal(int eligible, int excluded, int total)
            throws Exception {
                ...
                SegmentPreviewView.of(
                        ...
                        List.of(
                                SegmentExclusionReasonSummary.of(
                                        "DO_NOT_CONTACT", "Customer has do-not-contact enabled", 2),
                                SegmentExclusionReasonSummary.of(
                                        "MARKETING_OPT_OUT",
