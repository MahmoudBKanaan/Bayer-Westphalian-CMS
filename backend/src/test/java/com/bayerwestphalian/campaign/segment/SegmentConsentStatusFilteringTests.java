...
class SegmentConsentStatusFilteringTests {
    ...
    void normalizesConsentStatusFilterValues() {
        ...
        assertThat(
                        SegmentConsentStatusSupport.normalizeFilterValue(
                                SegmentOperator.IN, "consent_type", "marketing_email, guardian"))
    ...
    void treatsMissingConsentsAsNoValidConsentAndNoOptOut() {
        assertThat(
                        SegmentConsentStatusSupport.matchesCustomerConsents(
                                List.of(), SegmentOperator.EQUALS, "consent_status", "GIVEN", NOW))
                .isFalse();
        assertThat(
                        SegmentConsentStatusSupport.matchesCustomerConsents(
                                List.of(),
        ...
        assertThat(
                        SegmentConsentStatusSupport.matchesCustomerConsents(
                                List.of(), SegmentOperator.EQUALS, "opt_out", "false", NOW))
                .isTrue();
    }
    ...
    void matchesRejectedAndExpiredStatusesAndOptOutFromRejected() {
        ...
        assertThat(
                        SegmentConsentStatusSupport.matchesCustomerConsents(
                                List.of(rejected), SegmentOperator.EQUALS, "opt_out", "true", NOW))
                .isTrue();
        assertThat(
                        SegmentConsentStatusSupport.matchesCustomerConsents(
                                List.of(expired),
