...
class ProductOwnershipServiceTests {
    ...
    private static final UUID ACTOR_ID = UUID.fromString("10000000-0000-0000-0000-000000000101");
    ...
    void rejectsUpdateWithoutOwnershipFields() {
        assertThatThrownBy(
                        () ->
                                productOwnershipService.updateOwnership(
                                        OWNERSHIP_ID,
                                        new UpdateProductOwnershipCommand(null, null)))
                .isInstanceOf(ValidationException.class)
                .hasMessage("Product ownership validation failed");
    }
    ...
    void findsOwnershipsExpiringWithinMonths() throws Exception {
        ...
        List<ProductOwnershipView> views = productOwnershipService.findExpiringWithinMonths(3);
