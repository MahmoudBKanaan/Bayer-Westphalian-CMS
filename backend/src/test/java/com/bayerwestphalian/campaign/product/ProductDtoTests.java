...
class ProductDtoTests {
    ...
    void validatesCreateProductRequestFieldsFromKb() throws Exception {
        ...
        assertThat(
                ...
                .isTrue();
        assertThat(
                        field(CreateProductRequest.class, "price")
    ...
    void validatesUpdateAndSearchProductRequestFieldsFromKb() throws Exception {
        ...
        assertThat(
                ...
                .isTrue();
        assertThat(
                        field(UpdateProductRequest.class, "price")
                                .getAnnotation(DecimalMin.class)
                                .value())
                .isEqualTo("0.00");
    ...
    void rejectsCreateProductRequestWithoutRequiredKbFields() {
        CreateProductRequest request = new CreateProductRequest(" ", null, null, null, null, null);
