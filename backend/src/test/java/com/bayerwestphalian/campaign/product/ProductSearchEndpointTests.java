...
class ProductSearchEndpointTests {
    ...
    void exposesKbProductSearchEndpointOnGetProducts() throws Exception {
        Method searchMethod =
                ProductController.class.getMethod("searchProducts", ProductSearchRequest.class);

        assertThat(searchMethod.isAnnotationPresent(GetMapping.class)).isTrue();
        assertThat(searchMethod.getParameters()[0].isAnnotationPresent(ModelAttribute.class))
                .isTrue();
    }
