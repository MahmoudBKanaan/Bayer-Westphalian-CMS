...
class ProductRepositoryIntegrationTests {
    ...
    void productRepositoryFindsOnlyActiveProductsOrderedByName() {
        ...
        assertThat(productRepository.findActive())
    ...
    void ownershipRepositoryFindsCustomerOwnershipsOrderedByNewestStartDate() {
        ...
        ProductOwnership older =
                persistOwnership(
                        customer, product, LocalDate.of(2024, 1, 1), LocalDate.of(2025, 1, 1));
        ProductOwnership newer =
                persistOwnership(
                        customer, product, LocalDate.of(2025, 1, 1), LocalDate.of(2026, 1, 1));
        persistOwnership(
    ...
    void ownershipRepositoryFindsActiveOwnershipsByProductOrderedByNewestStartDate() {
        ...
        ProductOwnership older =
                persistOwnership(
                        customer, product, LocalDate.of(2024, 1, 1), LocalDate.of(2027, 1, 1));
        ProductOwnership newer =
                persistOwnership(
                        customer, product, LocalDate.of(2025, 1, 1), LocalDate.of(2028, 1, 1));
        ProductOwnership cancelled =
                persistOwnership(
                        customer, product, LocalDate.of(2026, 1, 1), LocalDate.of(2029, 1, 1));
        cancelled.cancel();
    ...
    void ownershipRepositoryFindsActiveOwnershipsExpiringInDateRange() {
        ...
        ProductOwnership first =
                persistOwnership(
                        customer, product, LocalDate.of(2025, 1, 1), LocalDate.of(2026, 1, 15));
        ProductOwnership second =
                persistOwnership(
                        customer, product, LocalDate.of(2025, 2, 1), LocalDate.of(2026, 3, 1));
        ProductOwnership expired =
                persistOwnership(
                        customer, product, LocalDate.of(2025, 3, 1), LocalDate.of(2026, 2, 1));
        expired.expire();
        entityManager.persistAndFlush(expired);
        persistOwnership(customer, product, LocalDate.of(2025, 4, 1), null);
        persistOwnership(customer, product, LocalDate.of(2025, 5, 1), LocalDate.of(2026, 6, 1));
