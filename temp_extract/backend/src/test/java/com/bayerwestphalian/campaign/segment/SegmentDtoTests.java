...
class SegmentDtoTests {
    ...
    void mapsCreateAndUpdateSegmentRequestsToCommands() {
        ...
        assertThat(createCommand.description())
                .isEqualTo("Customers with policies expiring soon");
    ...
    void rejectsCreateSegmentRequestWithoutRequiredKbFields() {
        CreateSegmentRequest request =
                new CreateSegmentRequest(" ", null, null, List.of());
    ...
    void normalizesSegmentSearchCriteriaForRepositoryFilters() {
        ...
        SegmentSearchCriteria criteria =
                new SegmentSearchRequest("  renewal audience  ", ownerUserId, SegmentVisibility.TEAM)
                        .toCriteria();
    ...
    void mapsSegmentAndCriteriaEntitiesToViews() {
        ...
        Segment segment =
                Segment.create(
                        ...
                        owner,
                        SegmentVisibility.TEAM);
        ReflectionTestUtils.setField(segment, "id", UUID.fromString("20000000-0000-0000-0000-000000000001"));
        ...
        ReflectionTestUtils.setField(criterion, "id", UUID.fromString("30000000-0000-0000-0000-000000000001"));
