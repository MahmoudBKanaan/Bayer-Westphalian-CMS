...
class SegmentCustomerTypeFilteringTests {
    ...
    void canonicalizesCustomerTypeAliasesToKbFieldName() {
        assertThat(SegmentCustomerTypeSupport.canonicalizeFieldName("type")).isEqualTo("customer_type");
    ...
    void normalizesCustomerTypeFilterValues() {
        assertThat(SegmentCustomerTypeSupport.normalizeFilterValue(SegmentOperator.EQUALS, "prospect"))
                .isEqualTo("PROSPECT");
        assertThat(
