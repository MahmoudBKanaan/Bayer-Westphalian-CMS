...
class ContactEventTests {
    ...
    private static final UUID CAMPAIGN_ID =
            UUID.fromString("50000000-0000-0000-0000-000000000280");
    private static final UUID CUSTOMER_ID =
            UUID.fromString("20000000-0000-0000-0000-000000000280");
    private static final UUID USER_ID =
            UUID.fromString("10000000-0000-0000-0000-000000000280");
    ...
    void mapsKbContactEventsTableAsJpaEntity() throws Exception {
        ...
        assertThat(Arrays.stream(ContactEvent.class.getAnnotation(Table.class).indexes())
                        .map(Index::name))
                .contains(
    ...
    void createsFailedContactEventWithFailureOutcomeAndNotes() {
        ...
        assertThat(event.getNotes()).isEqualTo("providerMessageId=mock-email-1; failureCode=BOUNCE");
        assertThat(event.getOccurredAt()).isEqualTo(occurredAt);
    }
    ...
    private static Customer customer() {
        Customer customer = Customer.create(CustomerType.INDIVIDUAL, "Ada", "Contacted");
