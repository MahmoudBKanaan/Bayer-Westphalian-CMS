...
class SegmentFilterByConsentStatusWorksTests {
    ...
    private static final UUID ID_REJECTED =
    ...
    private static final UUID ID_REQUIRED =
            UUID.fromString("20000000-0000-0000-0000-000000000705");
    private static final UUID ID_GUARDIAN =
            UUID.fromString("20000000-0000-0000-0000-000000000706");
    ...
    void consentStatusAndCityAndCombinationWorks() throws Exception {
        ...
        when(customerRepository.findActiveProfiles())
                .thenReturn(List.of(munichGiven, berlinGiven));
    ...
    private void stubConsentProfiles() throws Exception {
        ...
        when(customerRepository.findActiveProfiles())
                .thenReturn(
                        List.of(given, withdrawn, rejected, expired, required, guardian, none));
