...
class SegmentAndCriteriaFilteringTests {
    ...
    void pureAndRequiresEveryMatchTrue() {
        ...
        assertThat(SegmentCriteriaLogicSupport.matchesAllAnd(List.of(true, false, true)))
                .isFalse();
    ...
    void evaluateTreatsNullJoinOperatorsAsAnd() {
        assertThat(
                        SegmentCriteriaLogicSupport.evaluate(
                                List.of(true, true), List.of(null, null)))
                .isTrue();
        assertThat(
                        SegmentCriteriaLogicSupport.evaluate(
                                List.of(true, false), List.of(null, null)))
                .isFalse();
    }
    ...
    void emptyCriteriaListMatchesAllProfiles() {
        ...
        assertThat(SegmentCriteriaLogicSupport.matchesAllWithAnd(List.of(), command -> false))
                .isTrue();
        assertThat(SegmentCriteriaLogicSupport.matchesAllCriteria(null, command -> false))
                .isTrue();
    }
