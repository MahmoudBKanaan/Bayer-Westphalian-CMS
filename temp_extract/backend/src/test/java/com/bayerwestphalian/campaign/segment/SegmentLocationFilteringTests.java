...
class SegmentLocationFilteringTests {
    ...
    void resolvesCustomerLocationValues() {
        ...
        assertThat(SegmentLocationSupport.resolveCustomerValue(customer, "city")).isEqualTo("Munich");
    ...
    void matchesLocationValuesUsingKbOperators() {
        assertThat(
                        SegmentCriteria.matchesValue(
                                SegmentOperator.EQUALS, "Munich", "Munich"))
                .isTrue();
        assertThat(
                        SegmentCriteria.matchesValue(
                                SegmentOperator.EQUALS, "munich", "Munich"))
        ...
        assertThat(
                        SegmentCriteria.matchesValue(
                                SegmentOperator.CONTAINS, "mun", "Munich"))
                .isTrue();
        assertThat(
                        SegmentCriteria.matchesValue(
                                SegmentOperator.CONTAINS, "MUN", "Munich"))
        ...
        assertThat(
                        SegmentCriteria.matchesValue(
                                SegmentOperator.IN, "Munich,Berlin", "Berlin"))
                .isTrue();
        assertThat(
                        SegmentCriteria.matchesValue(
                                SegmentOperator.NOT_EQUALS, "Germany", "Austria"))
                .isTrue();
