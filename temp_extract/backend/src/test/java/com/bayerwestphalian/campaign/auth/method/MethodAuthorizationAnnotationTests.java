...
class MethodAuthorizationAnnotationTests {
    ...
    @Test
    void segmentCreateAccessUsesKbCampaignManagerSegmentCreationExpression() {
        assertMethodSecurityAnnotation(SegmentCreateAccess.class, "@authz.canCreateSegments()");
    }
