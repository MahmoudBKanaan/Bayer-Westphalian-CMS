...
class SegmentCriteriaTests {
    ...
    void createsCriterionWithKbDefaultsAndFields() {
        Segment segment = Segment.create("Customer audience", null, null, SegmentVisibility.PRIVATE);
    ...
    void matchesKbOperatorSemanticsForInBeforeAndAfter() {
        ...
        SegmentCriteria inCriterion =
                SegmentCriteria.create(segment, "policy_status", SegmentOperator.IN, "ACTIVE,LAPSED");
