...
class SegmentFilterByProductOwnershipWorksTests {
    ...
    void equalsProductTypeFilterMatchesOnlyOwnersOfThatType(
            String filterValue, String expectedName) throws Exception {
    ...
    void notEqualsProductTypeExcludesOwnersAndKeepsNonOwners() throws Exception {
        ...
        assertThat(matches)
                ...
                .containsExactlyInAnyOrder(
                        "Home Owner", "Fund Investor", "No Ownership", "Expired Policy", "Cancelled Policy");
    ...
    private void stubOwnershipProfiles() throws Exception {
        ...
        when(productOwnershipRepository.findByCustomerId(ID_LIFE))
                .thenReturn(
                        List.of(activeOwnership(life, ProductType.LIFE_INSURANCE, PRODUCT_LIFE_ID)));
        when(productOwnershipRepository.findByCustomerId(ID_HOME))
                .thenReturn(
                        List.of(
                                activeOwnership(
        ...
        expired.expire();
        when(productOwnershipRepository.findByCustomerId(ID_EXPIRED))
