...
class CampaignRecipientDtoTests {
    ...
    private static final UUID CAMPAIGN_ID =
            UUID.fromString("50000000-0000-0000-0000-000000000266");
    private static final UUID CUSTOMER_ID =
            UUID.fromString("20000000-0000-0000-0000-000000000266");
    private static final UUID OWNER_ID =
            UUID.fromString("10000000-0000-0000-0000-000000000266");
    ...
    void mapsEligibleCampaignRecipientEntityToView() {
        ...
        ReflectionTestUtils.setField(
                recipient, "createdAt", Instant.parse("2026-07-09T10:15:30Z"));
        recipient.markSent();
    ...
    void serializesCampaignRecipientViewWithIsoTimestamps() throws Exception {
        ...
        ReflectionTestUtils.setField(
                recipient, "createdAt", Instant.parse("2026-07-09T10:15:30Z"));
        ReflectionTestUtils.setField(
                recipient, "sentAt", Instant.parse("2026-07-09T11:00:00Z"));
        ReflectionTestUtils.setField(
                recipient, "openedAt", Instant.parse("2026-07-09T12:00:00Z"));
        ReflectionTestUtils.setField(recipient, "eligibilityStatus", CampaignRecipientStatus.OPENED);
    ...
    private static Customer customer() {
        Customer customer = Customer.create(CustomerType.INDIVIDUAL, "Ada", "Recipient");
