...
class SegmentPreviewViewTests {
    ...
    void eligiblePlusExcludedAlwaysEqualsTotalForValidViews() {
        ...
        assertThat(zero.eligibleCount() + zero.excludedCount()).isEqualTo(zero.totalAudienceCount());
    ...
    void ofRejectsWhenEligiblePlusExcludedDoesNotEqualTotal() {
        assertThatThrownBy(
                        () ->
                                new SegmentPreviewView(
                                        5, 2, 2, List.of(), List.of()))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("eligibleCount + excludedCount must equal totalAudienceCount");
    }
