...
class ContactEventDtoTests {
    ...
    private static final UUID EVENT_ID =
            UUID.fromString("63000000-0000-0000-0000-000000000317");
    private static final UUID CUSTOMER_ID =
            UUID.fromString("20000000-0000-0000-0000-000000000317");
    private static final UUID CAMPAIGN_ID =
            UUID.fromString("50000000-0000-0000-0000-000000000317");
    private static final UUID USER_ID =
            UUID.fromString("10000000-0000-0000-0000-000000000317");

    @Test
    void validatesRecordContactEventRequestFieldsFromKb() throws Exception {
        assertThat(field(RecordContactEventRequest.class, "customerId")
                        .isAnnotationPresent(NotNull.class))
                .isTrue();
        assertThat(field(RecordContactEventRequest.class, "channel")
                        .isAnnotationPresent(NotNull.class))
                .isTrue();
        assertThat(field(RecordContactEventRequest.class, "eventType")
                        .isAnnotationPresent(NotNull.class))
                .isTrue();
        assertThat(field(RecordContactEventRequest.class, "occurredAt")
                        .isAnnotationPresent(NotNull.class))
                .isTrue();
        assertThat(field(RecordContactEventRequest.class, "campaignId")
                        .isAnnotationPresent(NotNull.class))
                .isFalse();
        assertThat(field(RecordContactEventRequest.class, "outcome")
                        .isAnnotationPresent(NotNull.class))
                .isFalse();
        assertThat(field(RecordContactEventRequest.class, "notes")
                        .isAnnotationPresent(NotNull.class))
                .isFalse();
    }
    ...
    private static Customer customer() {
        Customer customer = Customer.create(CustomerType.INDIVIDUAL, "Ada", "Contact");
    ...
    private static User user() {
        User user =
                User.create(
                        "contact-event-dto@test.example",
                        "{noop}password",
                        "Contact Event User");
