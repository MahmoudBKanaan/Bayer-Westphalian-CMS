...
class SegmentRepositoryIntegrationTests {
    ...
    void segmentRepositoryFindsSegmentsByOwnerOrderedByName() {
        ...
        Segment betaOwned =
                persistSegment("Beta owned audience", owner, SegmentVisibility.PRIVATE);
        Segment alphaOwned =
                persistSegment("Alpha owned audience", owner, SegmentVisibility.TEAM);
    ...
    void segmentRepositoryFindsGlobalSegmentsOrderedByName() {
        ...
        Segment alphaGlobal = persistSegment("Alpha global audience", null, SegmentVisibility.GLOBAL);
