...
class SegmentPreviewAppliesEligibilityServiceWorksTests {
    ...
    private static final UUID ID_ELIGIBLE =
            UUID.fromString("20000000-0000-0000-0000-000000000b01");
    ...
    private static final UUID ID_OPT_OUT =
            UUID.fromString("20000000-0000-0000-0000-000000000b03");
    ...
    private static final UUID ID_BERLIN =
            UUID.fromString("20000000-0000-0000-0000-000000000b06");
    ...
    void applyEligibilityPathDelegatesToEvaluateForSegmentPreview() throws Exception {
        ...
        EligibilityDecision decision =
                (EligibilityDecision) apply.invoke(segmentService, view);
