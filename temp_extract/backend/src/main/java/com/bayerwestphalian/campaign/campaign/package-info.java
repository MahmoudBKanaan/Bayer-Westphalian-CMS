 ...
 *       selection + FR-053 segment selection + compliance review notes (item 231) + rejection reason
 *       (item 232) + CREATE audit on creation (item 233) + APPROVE audit on approval (item 235) +
 *       Campaign Manager draft creation (item 243 / FR-050 / FR-057)
 ...
 *   <li>{@link com.bayerwestphalian.campaign.campaign.EligibilityService} — contact eligibility gate
 * </ul>
 */
